...
* Calculate Cyclomatic Complexity for the *parser.c* and report in *results.txt*
...
# Compute Halstead
* Run provided *halstead.sh* on  *parser.c*, naming the output file *tokens.txt*
	* Command summary: `halstead source output-file`
